...
@interface QXHFuLiMyViewController ()<XXPageTabViewDelegate>
@property (nonatomic, strong) XXPageTabView *pageTabView;
@end

@implementation QXHFuLiMyViewController
...
- (void)setupSegmentType_0View {
    ...
    // 2.我的可使用
    QXHFuLiMyAllViewController *title_1VC = [[QXHFuLiMyAllViewController alloc] init];
    title_1VC.view.backgroundColor = [UIColor whiteColor];
    // 1.我的已作废
    QXHFuLiMyAllViewController *title_2VC = [[QXHFuLiMyAllViewController alloc] init];
    title_0VC.view.backgroundColor = [UIColor whiteColor];
    
    // 2.我的待支付
    QXHFuLiMyAllViewController *title_3VC = [[QXHFuLiMyAllViewController alloc] init];
    title_1VC.view.backgroundColor = [UIColor whiteColor];
