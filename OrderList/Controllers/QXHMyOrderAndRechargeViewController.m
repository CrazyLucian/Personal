//
//  QXHMyOrderAndRechargeViewController.m
//  quxianghui
//
...
@interface QXHMyOrderAndRechargeViewController ()<XXPageTabViewDelegate>
@property (nonatomic, strong) XXPageTabView *pageTabView;
@end

@implementation QXHMyOrderAndRechargeViewController
...
- (void)setupSegmentType_0View {
    // 1.我的订单
    QXHMyOrderViewController *title_0VC = [[QXHMyOrderViewController alloc] init];
    title_0VC.view.backgroundColor = [UIColor whiteColor];
    
    // 2.我的充值
    QXHMyRechargeViewController *title_1VC = [[QXHMyRechargeViewController alloc] init];
    title_1VC.view.backgroundColor = [UIColor whiteColor];
    
//    QXHMyRechargeViewController *title_2VC = [[QXHMyRechargeViewController alloc] init];
//    title_1VC.view.backgroundColor = [UIColor whiteColor];
